...
<div class="row" style="padding-top: 16px;">
	<div class="col-md-6" style="text-align:center;">
		...
		<div style="padding: 4px 8px;">
			<input autocomplete="off" class="form-control" id="pp-card-pay" name="payment-made" step="0.01" style="width: 98%;" type="number" value="0.00">
		</div>
	</div>
	<div class="col-md-6" style="text-align:center;">
		<span style="font-size:32px;">Due:</span>
		<div style="padding: 4px 8px;">
			<input autocomplete="off" class="form-control" id="payment-need" name="payment-need" step="0.01" style="width: 98%;" type="number" value="0.00">
		</div>
	</div>
</div>
<div class="row">
